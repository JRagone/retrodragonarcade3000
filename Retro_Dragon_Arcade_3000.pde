...
//mario
  ...
  float[] groundArray2;
  float goalPostX = 5;
  float backgroundBush1X;
  float backgroundBush2X;
...
//mario
  ...
  /*class backgroundImage {
    ...
    float backgroundImageX;
    
    backgroundImage(PImage backgroundImageInput, float backgroundX, float resizeImageInput){
      resizeImage = resizeImageInput;
      backgroundImage = backgroundImageInput;
      backgroundImageXInput = backgroundX;
    }
    
    void creation(){
      backgroundImageX = mX + backgroundImageXInput;
      backgroundImage.resize(0, 400);
